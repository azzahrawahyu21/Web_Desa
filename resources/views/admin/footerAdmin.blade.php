...
<footer class="py-5 border-top" style="background-color: #0D4715; color: #ffffff;">
  <div class="container">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start">
      ...
      <!-- Profil Desa (Tengah) -->
      <div class="mb-4 " style="flex: 1; margin-left: 200px;">
      ...
      <!-- Lokasi (Kanan) -->
      <div class="mb-4" style="flex: 1; margin-left: 100px;">
        <h6 class="fw-bold" style="color: #ffffff;">Lokasi</h6>
        <a href="https://maps.app.goo.gl/J1TVzhbwfVrxE5Li9" target="_blank">
          <img src="{{ asset('assets/img/navbar/lokasi.png') }}" class="img-fluid rounded shadow-sm" alt="Peta Lokasi" style="max-width: 180px;">
        </a>
      </div>
    </div>
